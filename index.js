...
function clickGridBox(id) {
    ...
    if ((document.getElementById('grid-item-1').innerText == document.getElementById('grid-item-2').innerText &&
        document.getElementById('grid-item-2').innerText == document.getElementById('grid-item-3').innerText) &&
        document.getElementById('grid-item-3').innerText != ''
        || (document.getElementById('grid-item-4').innerText == document.getElementById('grid-item-5').innerText &&
            document.getElementById('grid-item-5').innerText == document.getElementById('grid-item-6').innerText) &&
        document.getElementById('grid-item-6').innerText != ''
        || (document.getElementById('grid-item-7').innerText == document.getElementById('grid-item-8').innerText &&
            document.getElementById('grid-item-8').innerText == document.getElementById('grid-item-9').innerText) &&
        document.getElementById('grid-item-9').innerText != ''
        || (document.getElementById('grid-item-1').innerText == document.getElementById('grid-item-4').innerText &&
            document.getElementById('grid-item-4').innerText == document.getElementById('grid-item-7').innerText) &&
        document.getElementById('grid-item-7').innerText != ''
        || (document.getElementById('grid-item-2').innerText == document.getElementById('grid-item-5').innerText &&
            document.getElementById('grid-item-5').innerText == document.getElementById('grid-item-8').innerText) &&
        document.getElementById('grid-item-8').innerText != ''
        || (document.getElementById('grid-item-3').innerText == document.getElementById('grid-item-6').innerText &&
            document.getElementById('grid-item-6').innerText == document.getElementById('grid-item-9').innerText) &&
        document.getElementById('grid-item-9').innerText != ''
        || (document.getElementById('grid-item-1').innerText == document.getElementById('grid-item-5').innerText &&
            document.getElementById('grid-item-5').innerText == document.getElementById('grid-item-9').innerText) &&
        document.getElementById('grid-item-9').innerText != ''
        || (document.getElementById('grid-item-3').innerText == document.getElementById('grid-item-5').innerText &&
            document.getElementById('grid-item-5').innerText == document.getElementById('grid-item-7').innerText) &&
        document.getElementById('grid-item-7').innerText != '') {
